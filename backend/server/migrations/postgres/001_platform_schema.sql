...
-- Versioned authorization policy storage (one active version per tenant).
...
CREATE TABLE IF NOT EXISTS authorization_policies (
  id TEXT PRIMARY KEY,
  version_id TEXT NOT NULL REFERENCES authorization_policy_versions(id) ON DELETE CASCADE,
  resource_type TEXT NOT NULL,
  action TEXT NOT NULL,
  effect TEXT NOT NULL,
  priority INTEGER NOT NULL DEFAULT 0,
  required_relations JSONB NOT NULL DEFAULT '[]',
  required_subject_attributes JSONB NOT NULL DEFAULT '{}',
  required_resource_attributes JSONB NOT NULL DEFAULT '{}'
);
