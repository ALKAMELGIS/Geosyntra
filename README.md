...
Opens **Vite** at `http://localhost:5173/Geosyntra/` and **API** at `http://localhost:3001`.

Full guide: **[DEVELOPER_SETUP.md](DEVELOPER_SETUP.md)** · VS Code: open **`geosyntra.code-workspace`**
