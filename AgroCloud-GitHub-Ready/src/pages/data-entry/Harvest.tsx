...
export default function Harvest() {
  ...
  const pageTitle = isProductionPage ? 'Product & Selas Tracking' : 'Harvest Logging'
  const pageSubtitle = isProductionPage ? 'Configurable, layer-driven production data entry' : 'Configurable, layer-driven harvest data entry'
  const pageIcon = isProductionPage ? 'fa-solid fa-boxes-stacked' : 'fa-solid fa-tractor'
      ...
      <div className="ec-container ec-animate-in">
        <div className="ec-header">
          <div className="ec-title">
            ...
            <div>
              {pageTitle}
              <div className="ec-section-subtitle">{pageSubtitle}</div>
            </div>
          </div>
        </div>
