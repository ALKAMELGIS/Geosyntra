...
const ICON_PATHS: Record<GsIconName, JSX.Element> = {
  ...
  tag: (
    <>
      <path d="M4 12.5V6.5A2.5 2.5 0 0 1 6.5 4h6l7.5 7.5-7.5 7.5H6.5A2.5 2.5 0 0 1 4 16.5v-4" />
  ...
  github: (
    <>
      <path d="M9 19.5c-3 1.5-3-1.5-4-2" />
      <path d="M12 3.5c-4.5 0-8 3.6-8 8.1 0 3.6 2.3 6.7 5.5 7.8.5.1.7-.2.7-.5v-1.8c-2.2.5-2.7-1.1-2.7-1.1-.4-.9-1-1.2-1-1.2-.8-.5.1-.5.1-.5.9.1 1.4 1 1.4 1 .8 1.4 2.1 1 2.6.8.1-.6.3-1 .5-1.2-1.8-.2-3.6-.9-3.6-4 0-.9.3-1.6.8-2.2-.1-.2-.4-1 .1-2.1 0 0 .7-.2 2.2.8a7.6 7.6 0 0 1 4 0c1.5-1 2.2-.8 2.2-.8.5 1.1.2 1.9.1 2.1.5.6.8 1.3.8 2.2 0 3.1-1.9 3.8-3.7 4 .3.3.6.8.6 1.6v2.4c0 .3.2.6.7.5 3.2-1.1 5.5-4.2 5.5-7.8 0-4.5-3.6-8.1-8.1-8.1Z" />
    </>
  ),
  youtube: (
    <>
      <rect x="3" y="6.5" width="18" height="11" rx="3" />
      <path d="m10 10.5 6 3.5-6 3.5v-7Z" fill="currentColor" stroke="none" />
    </>
  ),
  'x-brand': (
    <>
