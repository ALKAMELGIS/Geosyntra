...
export function HomeOnboardingWizard() {
  const { open, step, closeWizard, wizardTheme, setWizardTheme } = useHomeOnboarding()
        ...
        >
          ...
          >
            ...
            <header className="home-wizard-shell__header">
              ...
              <div className="home-wizard-shell__header-end">
                <LuxThemeLightToggle
                  size="sm"
                  scope="wizard"
                  wizardTheme={wizardTheme}
                  onWizardThemeChange={setWizardTheme}
                  className="lux-theme-light--wizard-header"
                />
