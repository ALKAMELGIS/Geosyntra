...
import { ONBOARDING_PRO_MONTHS, planCreditsSummary } from '../../../../lib/onboarding/onboardingPlanFlow'
...
export function WizardLaunchStep() {
  const { enterWorkspace, trialDaysLeft, selectedPlanId } = useHomeOnboarding()
  const { user } = useAuth()
  ...
  return (
    <div className="home-wizard-step home-wizard-step--launch">
      ...
      {selectedPlanId === 'trial' && trialDaysLeft != null ? (
        ...
        <p className="home-wizard-trial-badge home-wizard-trial-badge--pro">Workspace active</p>
      )}
