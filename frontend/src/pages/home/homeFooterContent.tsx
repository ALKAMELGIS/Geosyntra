...
import type { GsIconName } from '../../components/ui/GsIcon'
...
export const homeFooterColumns: HomeFooterColumn[] = [
  {
    ...
    links: [
      ...
      { href: '#future', label: 'AOI & Analytics' },
  ...
  },
  {
    ...
    links: [
      ...
      { href: '#innovation', label: 'Vegetation indices' },
      { href: '#future', label: 'Change detection' },
...
export const homeFooterSocial: ReadonlyArray<{
  href: string
  label: string
  icon: GsIconName
}> = [
  { href: 'https://linkedin.com', label: 'LinkedIn', icon: 'linkedin' },
  { href: 'https://twitter.com', label: 'X (Twitter)', icon: 'x-brand' },
