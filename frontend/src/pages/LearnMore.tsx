            ...
            <div className="flex-1 p-8 md:p-12 relative z-10 flex flex-col justify-center">
              ...
              <div className="lm-hero-actions">
                <button
                  ...
                  onClick={() => navigate('/satellite/gis')}
                >
                  <GsIcon name="globe" size={15} /> Open GIS Map
                </button>
                <button
                  type="button"
                ...
                >
                  <GsIcon name="image" size={15} /> Explore Indices
                </button>
              </div>
            </div>
        ...
        <Card className="lm-dash-card">
          <div className="lm-dash-frame" aria-hidden>
            <div className="lm-dash-frame__chrome">
              ...
              <span className="lm-dash-frame__addr">geosyntra.app/satellite/gis</span>
            </div>
