...
const copy = (lang: 'en' | 'ar') => {
  const en = {
    ...
    stepRecipes: 'Recipes',
    subtitle: 'Columns match the primary fields enabled for this workflow in your stored data source bindings.',
    cardHint: 'No recipe rows saved yet.',
    emptyConfigured: 'No fields are configured yet for this workflow. Configure layers and fields in the data entry form, then return here.',
  ...
  const ar: typeof en = {
    ...
    emptyConfigured: 'لم يُضبط حقول لهذا النموذج بعد. اضبط الطبقات والحقول في نموذج إدخال البيانات ثم عد إلى هنا.',
