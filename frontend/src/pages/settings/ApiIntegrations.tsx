...
export default function ApiIntegrations() {
  ...
  const copy = ar
    ? {
        ...
        addHint: 'افتح معالج التكامل لاختيار المزوّد ونوع المصادقة وحفظ المفاتيح بأمان.',
    ...
    : {
        ...
        typePrefix: 'Type:',
        addNew: 'Add New API',
        addHint: 'Open the integration wizard to pick a provider, auth method, and store secrets securely.',
                ...
                <motion.div className="api-manager-row__info" whileHover={{ x: 2 }}>
                  ...
                  <div className="api-manager-row__text">
                    ...
                    <p className="api-manager-row__type">
                      {copy.typePrefix} {displayType(provider.category)}
                    </p>
                  </div>
                </motion.div>
