...
import { siMapWeatherCanvasOverlayActive } from '../utils/siMapToolIntegration';
import {
  siMapWeatherCloudVeilStrength,
  siMapWeatherNeedsParticleOverlay,
} from '../utils/siMapWeatherEffects';
import { isSiMapWeatherSnowPrecipActive } from '../utils/siMapWeatherActive';
...
export function SiMapWeatherOverlay({ settings, active }: SiMapWeatherOverlayProps) {
  ...
  useEffect(() => {
    ...
    if (!siMapWeatherCanvasOverlayActive(settings)) return;
    ...
    const isSnow = isSiMapWeatherSnowPrecipActive(settings);
  ...
  if (!siMapWeatherCanvasOverlayActive(settings)) return null;
