  ...
  return (
    <>
      <div className={`${pfx(cssPrefix, 'messages')} geo-agent-chat geo-agent-chat--google`}>
        <div className={`${pfx(cssPrefix, 'row')} ${pfx(cssPrefix, 'row--model')} geo-chat-welcome-row`}>
          <div className={`${pfx(cssPrefix, 'avatar')} geo-chat-welcome-avatar`} aria-hidden>
            <i className="fa-solid fa-globe" />
          </div>
          <div className={`${pfx(cssPrefix, 'bubble')} ${pfx(cssPrefix, 'bubble--welcome')} geo-chat-welcome-bubble`}>
            <p className={`${pfx(cssPrefix, 'bubble-text')} geo-chat-welcome-text`}>{AGENT_CHAT_WELCOME_EXPLORER}</p>
          </div>
        </div>
        {messages.map(msg => (
