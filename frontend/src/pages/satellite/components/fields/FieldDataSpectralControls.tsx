...
import { SiFieldAnalysisLayerVisibility } from './SiFieldAnalysisLayerVisibility'
...
export type FieldDataSpectralControlsProps = {
  ...
  /** Timeline play: layer visibility is display-only (no checkbox toggles). */
  ...
  return (
    <div className="gs-field-data-spectral-root" aria-label="Field Data scene and imagery">
      ...
      <div className="si-field-analysis-section">
        ...
        {layerOptions.length > 0 && (!layersLoading || layerVisibilityReadOnly) ? (
          <SiFieldAnalysisLayerVisibility
            visible={showLayerOnMap}
            layerLabel={resolvedLayerLabel}
            readOnly={layerVisibilityReadOnly}
            onVisibleChange={layerVisibilityReadOnly ? undefined : onShowLayerOnMapChange}
          />
        ) : null}
        <button
          type="button"
