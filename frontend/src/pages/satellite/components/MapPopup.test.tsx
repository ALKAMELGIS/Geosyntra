...
describe('MapPopup', () => {
  it('renders layer name as popup title', () => {
    render(
      <MapPopup
        popup={basePopup}
        pos={basePos}
    ...
    expect(screen.getByText('Layer 1', { selector: '.gis-map-popup-title' })).toBeInTheDocument()
    expect(screen.getByText('NH-08')).toBeInTheDocument()
  })
