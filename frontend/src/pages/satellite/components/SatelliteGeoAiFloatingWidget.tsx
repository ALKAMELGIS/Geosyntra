...
import { AGENT_CHAT_PANEL_TITLE, AGENT_CHAT_CLEAR_LABEL } from '../../../lib/agentChatCopy';
...
export type SatelliteGeoAiFloatingWidgetProps = {
  ...
  onRequestClose: () => void;
  /** Clears the active model thread (Gemini / Claude / DeepSeek). */
  onClearChat?: () => void;
        ...
        {expanded ? (
          <div
            className={[
              ...
              'si-geo-ai-float-panel--google-geo',
            ...
            <div className="si-geo-ai-float-head" onPointerDown={onPointerDownPanelMove}>
              ...
              <div className="si-geo-ai-float-actions">
                {onClearChat ? (
                  <button
                    type="button"
                    className="si-geo-ai-float-clear-btn"
                    title={AGENT_CHAT_CLEAR_LABEL}
                    aria-label={AGENT_CHAT_CLEAR_LABEL}
                    onClick={ev => {
                      ev.stopPropagation();
                      onClearChat();
                    }}
                  >
                    ...
                    <span>{AGENT_CHAT_CLEAR_LABEL}</span>
                  </button>
                ) : null}
                <button
                  type="button"
