 ...
 */
import { computeLandCoverFromRasterLayers, type LandCoverBreakdown } from './liveAoiLandCover';
import {
...
export function buildSiAoiReportLiveAnalysisSnapshot(opts: {
  ...
  const landCover = computeLandCoverFromRasterLayers(opts.rasterSample.layers);
  ...
  return {
    ...
    healthPrimaryMean: health?.primaryMean ?? null,
    landCover,
    histograms: opts.rasterSample.histograms ?? {},
