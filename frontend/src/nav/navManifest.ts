...
/** When a group has exactly one visible leaf, the header icon navigates there (unified page). */
export function singleVisibleNavPath(children: Array<{ visible: boolean; path: string }>): string | null {
