 ...
 *
 * Why this matters:
 *   • Without prefetch, the first click on a heavy route (SatelliteIntelligence, …) pays the full network +
...
const ROUTE_FACTORIES: Record<string, RouteFactory> = {
  ...
  '/settings/gis-content': () => import('../pages/settings/gis-content/GisContent'),
