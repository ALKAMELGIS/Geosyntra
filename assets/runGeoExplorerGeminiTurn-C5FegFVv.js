import{buildGisContentLayersContext as j}from"./geoAiChatClaude-Dum2zIaA.js";import{a2 as X,bb as V,d as z,af as J,bc as Z,i as ee,e as te,G as ae,p as O,bd as c,be as h,bf as b,h as ne,bg as P,bh as oe,bi as ie,bj as se,bk as re,bl as le,bm as ce,bn as de,bo as me,bp as pe,ai as ue,bq as ye,aj as fe}from"./fieldsStore-BEU5hFrs.js";import{a7 as Re}from"./fieldsStore-BEU5hFrs.js";import{g as he}from"./geoExplorerGeminiApi-egIRxMiY.js";import"./index-DdBZE5Xk.js";function ge(p,u){const e=(u[1]-p[1])*Math.PI/180,d=(u[0]-p[0])*Math.PI/180,g=p[1]*Math.PI/180,$=u[1]*Math.PI/180,M=Math.sin(e/2)*Math.sin(e/2)+Math.cos(g)*Math.cos($)*Math.sin(d/2)*Math.sin(d/2);return 2*6371*Math.asin(Math.min(1,Math.sqrt(M)))}async function Ie(p){var T;const{apiKey:u,historyWithUser:A,userTextForMapFallback:e,primaryVectorLayers:d,mapboxAccessToken:g,openWeatherApiKey:$,pinLngLat:M,lastMapQueryCoords:C,inspectAnchorLngLat:N,mapPopup:Q,addedLayersHeading:U,attachGisSavedLayers:k,extraSystemAppend:E,questionEditInPlace:q}=p,D=k===!0;let m=[...d],R=`### GIS Content (saved layers from GIS Map)
