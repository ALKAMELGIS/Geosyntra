import{r as S,al as O,am as f}from"./index-CzObcEQt.js";function C(){return S.useSyncExternalStore(O,f,f)}const G=`You are "Geo Explorer" / Geo AI: a concise assistant inside a map workspace (satellite globe or GIS map).
