import{a as S}from"./apiGatewayClient-BCu1WSG3.js";import{a4 as b,a3 as f,aq as v,ar as D,as as G}from"./SatelliteIntelligenceMain-CSRIlHnH.js";import{at as J}from"./SatelliteIntelligenceMain-CSRIlHnH.js";import{h as A}from"./index-C7jihNb2.js";import"./useSubscription-Db2iJjU8.js";import"./mapboxAccessToken-BdfCMWq8.js";import"./sentinelHubWmsCapabilities-4Qq8Fffo.js";import"./systemTokensApi-CIx7lz1i.js";import"./index-bockOCqo.js";function w(e){const a=e;return Array.isArray(a.fields)?a.fields:[]}function m(e){var o;const a=w(e).slice(0,48).join(", ");let t="";const n=e.data;if((o=n==null?void 0:n.features)!=null&&o.length){const r=n.features[0],s=r==null?void 0:r.properties,i=e.source==="arcgis"?e.arcgisLayerDefinition??void 0:void 0;if(s&&typeof s=="object"){const p=i&&typeof i=="object"?D(s,r,i):s;t=` | ${i&&typeof i=="object"?"example attributes (domain/subtype descriptions)":"example attributes"}: ${JSON.stringify(p).slice(0,420)}`}const u=n.features,c=G(u,2400);c&&(t+=` | ${c}`)}return`- ${e.name} (type=${e.type}, source=${e.source??"n/a"}, visible=${e.visible}) fields=[${a||"—"}]${t}`}async function M(e=4e4){try{const a=await f();let t=a.length>0?`### GIS Content (layers saved in this browser)
`+a.map(m).join(`
`):`### GIS Content
