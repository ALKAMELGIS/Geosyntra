import{buildGisContentLayersContext as te}from"./geoAiChatClaude-DUg0hXuk.js";import{T as ne,a2 as oe,$ as ae,Y as Q,a0 as ie,a3 as se,a4 as le,a5 as re,a6 as ce,a7 as de,a8 as ue,a9 as pe,aa as ge,K,I as x,ab as C,ac as N,ad as me,ae as B,af as fe,ag as he,ah as ye,ai as $e,aj as Le,Z as Ee,_ as Ge,ak as xe,al as Me,am as be,an as ve,ao as Pe}from"./SatelliteIntelligenceMain-BDjHH0Ao.js";import{ap as ot}from"./SatelliteIntelligenceMain-BDjHH0Ao.js";import{g as Se}from"./geoExplorerGeminiApi-BRuLhXGJ.js";import{d as we}from"./intentDetector-Cg7MVrOW.js";import{readGeoSpatialMemory as _e,groundingSuggestionChipsFromMemory as Ce,writeGeoSpatialMemory as Ie}from"./spatialMemory-DwP1Bk4f.js";import"./apiGatewayClient-C-Mrh0J2.js";import"./index-CE2PB-2M.js";import"./useSubscription-wdV5DDft.js";import"./mapboxAccessToken-zDExDXHa.js";import"./sentinelHubWmsCapabilities-CQEQwBQb.js";import"./systemTokensApi-CZbw9Af1.js";import"./index-DtuH5thg.js";function Ae(e){if(!e)return"";const t=["### Geo Dataset Engine — AOI snapshot"];return e.label&&t.push(`- Label: ${e.label}`),e.bbox&&t.push(`- Bbox (W,S,E,N): ${e.bbox.map(h=>Number(h).toFixed(5)).join(", ")}`),e.areaHa!=null&&t.push(`- Area (ha): ${e.areaHa.toFixed(2)}`),e.timelineLabel&&t.push(`- Timeline: ${e.timelineLabel}`),e.layerId&&t.push(`- Layer: ${e.layerId}`),e.ndviMean!=null&&t.push(`- NDVI: mean ${e.ndviMean.toFixed(3)}${e.ndviMin!=null?`, min ${e.ndviMin.toFixed(3)}`:""}${e.ndviMax!=null?`, max ${e.ndviMax.toFixed(3)}`:""}`),t.length>1?t.join(`
