import{buildGisContentLayersContext as oe}from"./geoAiChatClaude-iSs0KR7P.js";import{k as ae,B as ie,y as se,q as Q,z as le,C as re,D as ce,E as de,F as ue,G as pe,H as ge,I as me,J as fe,g as V,e as x,K as A,L as k,M as he,N as B,O as ye,P as Le,Q as $e,R as Ee,S as Ge,t as xe,x as Me,T as be,U as Se,V as ve,W as Pe,X as we,Y as _e}from"./SatelliteIntelligenceMain-CuVBZq1q.js";import{Z as at}from"./SatelliteIntelligenceMain-CuVBZq1q.js";import{c as Ie}from"./geoExplorerGeminiApi-DwSNCZQH.js";import{d as Ae}from"./intentDetector-Cg7MVrOW.js";import{readGeoSpatialMemory as Re,groundingSuggestionChipsFromMemory as Ce,writeGeoSpatialMemory as Oe}from"./spatialMemory-DwP1Bk4f.js";import"./index-CNYQzPgh.js";import"./useSubscription-DmWLsy2q.js";import"./sentinelHubWmsCapabilities-B7f69KnF.js";import"./systemTokensApi-m3rbi1nb.js";import"./index-CkR9_B-Z.js";function Te(e){if(!e)return"";const t=["### Geo Dataset Engine — AOI snapshot"];return e.label&&t.push(`- Label: ${e.label}`),e.bbox&&t.push(`- Bbox (W,S,E,N): ${e.bbox.map(h=>Number(h).toFixed(5)).join(", ")}`),e.areaHa!=null&&t.push(`- Area (ha): ${e.areaHa.toFixed(2)}`),e.timelineLabel&&t.push(`- Timeline: ${e.timelineLabel}`),e.layerId&&t.push(`- Layer: ${e.layerId}`),e.ndviMean!=null&&t.push(`- NDVI: mean ${e.ndviMean.toFixed(3)}${e.ndviMin!=null?`, min ${e.ndviMin.toFixed(3)}`:""}${e.ndviMax!=null?`, max ${e.ndviMax.toFixed(3)}`:""}`),t.length>1?t.join(`
