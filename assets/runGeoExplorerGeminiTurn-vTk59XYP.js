import{buildGisContentLayersContext as oe}from"./geoAiChatClaude-CeDsYsoW.js";import{k as ae,B as ie,y as se,q as Q,z as le,C as re,D as ce,E as de,F as ue,G as pe,H as ge,I as me,J as fe,K as he,L as ye,M as Le,N as $e,O as Ee,g as V,e as x,P as A,Q as k,R as Ge,S as B,T as xe,U as Me,V as be,W as Se,X as ve,t as Pe,x as we,Y as _e}from"./SatelliteIntelligenceMain-DsjMslVc.js";import{Z as at}from"./SatelliteIntelligenceMain-DsjMslVc.js";import{g as Ie}from"./geoExplorerGeminiApi-cEpm58YS.js";import{d as Ae}from"./intentDetector-Cg7MVrOW.js";import{readGeoSpatialMemory as Re,groundingSuggestionChipsFromMemory as Ce,writeGeoSpatialMemory as Oe}from"./spatialMemory-DwP1Bk4f.js";import"./index-DeWPJi6b.js";import"./useSubscription-Bls9pmrD.js";import"./sentinelHubWmsCapabilities-D3Cslgzb.js";import"./systemTokensApi-tqxFRFSN.js";import"./index-DanQ919W.js";function Te(e){if(!e)return"";const t=["### Geo Dataset Engine — AOI snapshot"];return e.label&&t.push(`- Label: ${e.label}`),e.bbox&&t.push(`- Bbox (W,S,E,N): ${e.bbox.map(h=>Number(h).toFixed(5)).join(", ")}`),e.areaHa!=null&&t.push(`- Area (ha): ${e.areaHa.toFixed(2)}`),e.timelineLabel&&t.push(`- Timeline: ${e.timelineLabel}`),e.layerId&&t.push(`- Layer: ${e.layerId}`),e.ndviMean!=null&&t.push(`- NDVI: mean ${e.ndviMean.toFixed(3)}${e.ndviMin!=null?`, min ${e.ndviMin.toFixed(3)}`:""}${e.ndviMax!=null?`, max ${e.ndviMax.toFixed(3)}`:""}`),t.length>1?t.join(`
